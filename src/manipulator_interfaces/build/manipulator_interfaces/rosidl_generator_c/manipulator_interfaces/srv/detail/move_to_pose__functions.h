...
#ifndef MANIPULATOR_INTERFACES__SRV__DETAIL__MOVE_TO_POSE__FUNCTIONS_H_
#define MANIPULATOR_INTERFACES__SRV__DETAIL__MOVE_TO_POSE__FUNCTIONS_H_
...
#include "manipulator_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_manipulator_interfaces
bool
 ...
 * calls
 * manipulator_interfaces__srv__MoveToPose_Request__init().
...
/**
 * It calls
 * manipulator_interfaces__srv__MoveToPose_Request__fini()
 ...
 * manipulator_interfaces__srv__MoveToPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * manipulator_interfaces__srv__MoveToPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * manipulator_interfaces__srv__MoveToPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_manipulator_interfaces
...
/**
 * It calls
 * manipulator_interfaces__srv__MoveToPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_manipulator_interfaces
...
/**
 * It allocates the memory for the array and calls
 * manipulator_interfaces__srv__MoveToPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_manipulator_interfaces
...
/**
 * It calls
 * manipulator_interfaces__srv__MoveToPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MANIPULATOR_INTERFACES__SRV__DETAIL__MOVE_TO_POSE__FUNCTIONS_H_
