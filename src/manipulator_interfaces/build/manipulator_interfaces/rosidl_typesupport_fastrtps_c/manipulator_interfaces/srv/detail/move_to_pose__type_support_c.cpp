...
#include "manipulator_interfaces/srv/detail/move_to_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "manipulator_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_manipulator_interfaces
...
using _MoveToPose_Request__ros_msg_type = manipulator_interfaces__srv__MoveToPose_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_manipulator_interfaces
size_t get_serialized_size_manipulator_interfaces__srv__MoveToPose_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveToPose_Request__ros_msg_type * ros_message = static_cast<const _MoveToPose_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MoveToPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_manipulator_interfaces__srv__MoveToPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_manipulator_interfaces
size_t max_serialized_size_manipulator_interfaces__srv__MoveToPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = manipulator_interfaces__srv__MoveToPose_Request;
    is_plain =
      (
...
static size_t _MoveToPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_manipulator_interfaces__srv__MoveToPose_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, manipulator_interfaces, srv, MoveToPose_Request)() {
...
using _MoveToPose_Response__ros_msg_type = manipulator_interfaces__srv__MoveToPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_manipulator_interfaces
size_t get_serialized_size_manipulator_interfaces__srv__MoveToPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveToPose_Response__ros_msg_type * ros_message = static_cast<const _MoveToPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_manipulator_interfaces__srv__MoveToPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_manipulator_interfaces
size_t max_serialized_size_manipulator_interfaces__srv__MoveToPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = manipulator_interfaces__srv__MoveToPose_Response;
    is_plain =
      (
...
static size_t _MoveToPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_manipulator_interfaces__srv__MoveToPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, manipulator_interfaces, srv, MoveToPose_Response)() {
...
// already included above
// #include "manipulator_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "manipulator_interfaces/srv/move_to_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, manipulator_interfaces, srv, MoveToPose)() {
