...
#include "manipulator_interfaces/srv/detail/move_to_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_manipulator_interfaces
cdr_serialize(
  const manipulator_interfaces::srv::MoveToPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  manipulator_interfaces::srv::MoveToPose_Request & ros_message)
{
  // Member: target_pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = manipulator_interfaces::srv::MoveToPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const manipulator_interfaces::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<manipulator_interfaces::srv::MoveToPose_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_manipulator_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<manipulator_interfaces::srv::MoveToPose_Request>()
{
  return &manipulator_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulator_interfaces, srv, MoveToPose_Request)() {
  return &manipulator_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_manipulator_interfaces
cdr_serialize(
  const manipulator_interfaces::srv::MoveToPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  manipulator_interfaces::srv::MoveToPose_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = manipulator_interfaces::srv::MoveToPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const manipulator_interfaces::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<manipulator_interfaces::srv::MoveToPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &manipulator_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulator_interfaces, srv, MoveToPose_Response)() {
  return &manipulator_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose_Response__handle;
}
...
{
  return &manipulator_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulator_interfaces, srv, MoveToPose)() {
  return &manipulator_interfaces::srv::typesupport_fastrtps_cpp::_MoveToPose__handle;
}
