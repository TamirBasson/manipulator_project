...
class Metaclass_MoveToPose_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('manipulator_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'manipulator_interfaces.srv.MoveToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from manipulator_interfaces.srv import _move_to_pose
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    from manipulator_interfaces.srv._move_to_pose import MoveToPose_Request as Request
    from manipulator_interfaces.srv._move_to_pose import MoveToPose_Response as Response
