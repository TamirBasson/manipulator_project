...
: ${AMENT_CURRENT_PREFIX:="/home/tamir/manipulator_project/config/robot_moveit_config/install/robot_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_moveit_config/environment/path.sh"
